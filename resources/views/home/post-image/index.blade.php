                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                    ...
                    @foreach($posts as $key=>$post)
                        ...
                        <tr class="border-b border-gray-200 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{route('imageUpload',[$post->id])}}" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none
                             focus:ring-cyan-300 dark:focus:ring-cyan-800
                             font-medium rounded-lg text-sm
                              px-5 py-2.5 text-center me-2 mb-2">Add/view</a>
                            </td>
